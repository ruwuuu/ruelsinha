...
export declare class WebWorkerEngine implements PdfEngine {
     ...
     * @public
     */
    getPageAnnoWidgets(doc: PdfDocumentObject, page: PdfPageObject): WorkerTask<PdfWidgetAnnoObject[], unknown>;
    getDocumentJavaScriptActions(doc: PdfDocumentObject): WorkerTask<PdfDocumentJavaScriptActionObject[], unknown>;
    getPageWidgetJavaScriptActions(doc: PdfDocumentObject, page: PdfPageObject): WorkerTask<PdfWidgetJavaScriptActionObject[], unknown>;
    /**
     ...
     * @public
     */
    setFormFieldState(doc: PdfDocumentObject, page: PdfPageObject, annotation: PdfWidgetAnnoObject, field: PdfWidgetAnnoField): WorkerTask<boolean, unknown>;
    renameWidgetField(doc: PdfDocumentObject, page: PdfPageObject, annotation: PdfWidgetAnnoObject, name: string): WorkerTask<boolean, unknown>;
    shareWidgetField(doc: PdfDocumentObject, sourcePage: PdfPageObject, sourceAnnotation: PdfWidgetAnnoObject, targetPage: PdfPageObject, targetAnnotation: PdfWidgetAnnoObject): WorkerTask<boolean, unknown>;
    regenerateWidgetAppearances(doc: PdfDocumentObject, page: PdfPageObject, annotationIds: string[]): WorkerTask<boolean, unknown>;
    /**
    ...
    createDocument(id: string): WorkerTask<PdfDocumentObject, unknown>;
    importPages(destDoc: PdfDocumentObject, srcDoc: PdfDocumentObject, srcPageIndices: number[], insertIndex?: number): WorkerTask<PdfPageObject[], unknown>;
    deletePage(doc: PdfDocumentObject, pageIndex: number): WorkerTask<boolean, unknown>;
    /**
     ...
     * @public
     */
    exportAnnotationAppearanceAsPdf(doc: PdfDocumentObject, page: PdfPageObject, annotation: PdfAnnotationObject): WorkerTask<ArrayBuffer, unknown>;
    exportAnnotationsAppearanceAsPdf(doc: PdfDocumentObject, page: PdfPageObject, annotations: PdfAnnotationObject[]): WorkerTask<ArrayBuffer, unknown>;
    /**
