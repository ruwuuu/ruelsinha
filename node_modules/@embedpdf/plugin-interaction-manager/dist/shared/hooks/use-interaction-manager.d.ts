import { InteractionDocumentState, InteractionManagerPlugin, PointerEventHandlersWithLifecycle } from '../../index.ts';
...
export declare function useInteractionManager(documentId: string): {
    provides: import('../../index.ts').InteractionManagerScope | null;
