...
export declare function CalloutFreeText({ documentId, isSelected, isEditing, annotation, pageIndex, scale, onClick, appearanceActive, }: CalloutFreeTextProps): import("preact").JSX.Element;
export {};
